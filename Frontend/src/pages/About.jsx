      ...
      <section className="bg-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">About CLOSET & CO®</h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We are passionate about bringing you the latest fashion trends with quality and style that everyone can afford.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Founded with a vision to make fashion accessible to everyone, @ocrf® has been at the forefront 
                of bringing trendy and affordable clothing to fashion enthusiasts worldwide.
              </p>
              <p className="text-gray-600 mb-4 leading-relaxed">
                We believe that everyone deserves to look and feel their best without breaking the bank. 
                Our carefully curated collections for men, women, and kids reflect the latest trends while 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              The principles that guide everything we do at @ocrf®
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We believe great fashion shouldn't come with a hefty price tag.
              </p>
            </div>
